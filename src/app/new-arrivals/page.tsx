...
export default function NewArrivalsPage() {
  return (
    <div className="pb-20 max-w-6xl mx-auto px-4 md:px-8 space-y-12">
      {/* Hero Banner */}
      <div className="bg-pink-300 border-b-4 border-black p-8 md:p-16 shadow-[0px_8px_0px_0px_rgba(0,0,0,1)] relative overflow-hidden mt-8 flex flex-col items-center text-center animate-slide-in">
        <Link href="/">
      ...
      <section id="etalase" className="pt-4">
        <Suspense fallback={<div className="py-20 text-center font-black text-2xl uppercase">Mensinkronisasi Data... ⚙️</div>}>
          <ProductGrid limit={20} initialCategory="Semua" />
        </Suspense>
      </section>
    </div>
  );
